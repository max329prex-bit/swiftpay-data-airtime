import { motion, AnimatePresence } from "framer-motion";
  ...
  /**
   * SplashScreen — shown for ~2.5 seconds on first app load.
   * The Blitz logo rolls (rotates like a wheel) continuously.
   * At 0.8s, "BlitzPay" slides up from below.
   * At 2.2s, the whole screen fades out and onDone() fires.
   */
  export function SplashScreen({ onDone }: { onDone: () => void }) {
    ...
    useEffect(() => {
      // Name appears at 0.8 seconds
      const t1 = setTimeout(() => setShowName(true), 800);
      // Begin exit fade at 2.0 seconds
      const t2 = setTimeout(() => setExiting(true), 2000);
      // Call onDone at 2.5 seconds
    ...
    return (
      ...
      >
        ...
        {/* BlitzPay name — slides up from below at 0.8s */}
