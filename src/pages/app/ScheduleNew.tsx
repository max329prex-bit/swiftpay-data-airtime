            ...
            {isGiftPlan(plan.id) && (
              <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 px-3 py-2">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-amber-200 leading-relaxed">
                    <span className="font-semibold">Non-owing line required.</span> If {phone} is currently owing data, this purchase will fail and be refunded. <button type="button" onClick={() => { setHideGiftPlans(true); }} className="text-amber-300 underline font-semibold cursor-pointer hover:text-amber-100 transition">Click here to see regular plans</button>.
                  </div>
                </div>
              </div>
            )}
