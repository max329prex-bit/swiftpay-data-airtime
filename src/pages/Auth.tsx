...
export default function Auth() {
  ...
  async function verifyCode() {
    ...
    try {
      ...
      if (error) throw error;
      toast.success("Email verified! Welcome to SwiftlyPay!");
      nav("/app");
        ...
        <div className="gloss-strong rounded-3xl p-8 shadow-card">
          ...
          {step === "verify" ? (
            ...
            <>
              ...
              <p className="mt-1 text-sm text-muted-foreground">{mode === "signup" ? "30 seconds. No paperwork." : "Sign in to your SwiftlyPay wallet."}</p>
              ...
              <form onSubmit={submit} className="space-y-3">
                ...
                <div><Label htmlFor="em">Email</Label><Input id="em" type="email" required value={email} onChange={e => setEmail(e.target.value)} className="mt-1" placeholder="you@swiftlypay.ng" /></div>
              ...
              <div className="mt-5 text-center text-sm text-muted-foreground">
                {mode === "signup" ? "Already have an account? " : "New to SwiftlyPay? "}
